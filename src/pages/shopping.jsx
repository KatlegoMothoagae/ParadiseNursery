...
function ShoppingPage() {
    ...
    // let total = plantItems()let
    // let filteredPlants =

    // const filteredPlants = (category) => {
    //     <div className="air-purifying-plants">
    //         <h1 className="plant-category">Low Light Plants</h1>
    //         <div className="plants">
    //             {filteredPlants("low-light")}
    //         </div>
    //     </div>
    //     <div className="air-purifying-plants">
    //         <h1 className="plant-category">Air purifying plants</h1>
    //         <div className="plants">
    //             {filteredPlants("air purifying plant")}
    //         </div>
    //     </div>
    //     <div className="air-purifying-plants">
    //         <h1 className="plant-category">Succulents and Cacti</h1>
    //         <div className="plants">
    //             {filteredPlants("succulents")}
    //         </div>
    //     </div>
            ...
            <header id="shopping-header">
                ...
                <Link to='/cart'>
                    <div className="wrapper"
                        ...
                        <div className="content" style={{backgroundColor: '#298e46'}}>
                            {getTotal()}
                        </div>
                        <svg
